CREATE DATABASE IF NOT EXISTS `food_paradise`
...
INSERT INTO `announcement_blog` VALUES
(1,'This is a test announcement','**Bold**\r\n*Italic*\r\n__Underline__\r\n~~Strikethrough~~\r\n```\r\nCode Block\r\n```','2025-12-14 13:14:05','2025-12-14 13:14:05'),
...
CREATE TABLE `products` (
  ...
  `size_prices` longtext DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `product_addons` VALUES
(1,1,1),
(1,2,0),
(1,3,0),
(2,1,1),
...
(1,'admin','admin','admin','fishbaitssgg@gmail.com',
'$2y$10$u/aVKFcL8zR3CouZSDWjjewwdzVsOW00b5CSSL.s2CKTNm1QvtzYa',
'admin',NULL,NULL,'2025-12-14 12:24:33');
