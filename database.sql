...
-- Data for table `addons`
INSERT INTO `addons`(`addon_id`,`addon_name`,`addon_price`,`created_at`) 
VALUES 
...
-- Data for table `announcement_blog`
INSERT INTO `announcement_blog`(`announcement_id`,`title`,`content`,`created_at`,`updated_at`) 
VALUES 
...
INSERT INTO `products`(`product_id`,`product_name`,`description`,`price`,`image_path`,`category`,`size_type`,`size_prices`,`created_at`) 
VALUES 
...
INSERT INTO `users`(`user_id`,`first_name`,`last_name`,`username`,`email`,`password`,`role`,`otp_code`,`otp_expiry`,`created_at`) 
VALUES 
